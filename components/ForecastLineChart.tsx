...
const ForecastLineChart: React.FC<ForecastLineChartProps> = ({ data }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg h-[28rem] flex flex-col transition-colors">
            <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-200 mb-4">Monthly Trend (Budget vs. Forecast)</h3>
