...
export const ClockIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <circle cx="12" cy="12" r="9" fill="url(#clockGradient)" fillOpacity="0.1" stroke="currentColor" strokeWidth="1.5"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2" stroke="currentColor" strokeWidth="2"/>
        <circle cx="12" cy="12" r="1.5" fill="currentColor" opacity="0.6"/>
        <circle cx="12" cy="6" r="0.8" fill="currentColor" opacity="0.4"/>
        <circle cx="16" cy="14" r="0.8" fill="currentColor" opacity="0.4"/>
    </svg>
);
...
export const CpuChipIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <rect x="6" y="6" width="12" height="12" rx="2" fill="url(#cpuGradient)" fillOpacity="0.1" stroke="currentColor" strokeWidth="1.5"/>
        <rect x="8" y="8" width="8" height="8" rx="1" fill="url(#cpuGradient)" fillOpacity="0.2" stroke="currentColor" strokeWidth="1"/>
        <rect x="10" y="10" width="4" height="4" rx="0.5" fill="currentColor" opacity="0.6"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 3v3M15 3v3M9 18v3M15 18v3M3 9h3M18 9h3M3 15h3M18 15h3" stroke="currentColor" strokeWidth="1.5"/>
        <circle cx="10.5" cy="10.5" r="0.5" fill="currentColor" opacity="0.8"/>
        <circle cx="13.5" cy="10.5" r="0.5" fill="currentColor" opacity="0.8"/>
        <circle cx="10.5" cy="13.5" r="0.5" fill="currentColor" opacity="0.8"/>
        <circle cx="13.5" cy="13.5" r="0.5" fill="currentColor" opacity="0.8"/>
    </svg>
);
...
export const ArrowTrendingDownIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="m17.25 18 4.5-4.5" />
    </svg>
);
...
export const MagnifyingGlassIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <circle cx="10.5" cy="10.5" r="7.5" fill="url(#searchGradient)" fillOpacity="0.1" stroke="currentColor" strokeWidth="1.5"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
        <circle cx="10.5" cy="10.5" r="3" fill="url(#searchGradient)" fillOpacity="0.2"/>
        <circle cx="8.5" cy="8.5" r="0.8" fill="currentColor" opacity="0.4"/>
    </svg>
);
...
export const Cog6ToothIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a6.759 6.759 0 0 1 0 .255c-.008.378.137.75.43.991l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z" fill="url(#cogGradient)" fillOpacity="0.1"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" fill="url(#cogGradient)" fillOpacity="0.2"/>
        <circle cx="12" cy="12" r="1.5" fill="currentColor" opacity="0.6"/>
    </svg>
);
...
export const EyeIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" fill="url(#eyeGradient)" fillOpacity="0.1"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" fill="url(#eyeGradient)" fillOpacity="0.2"/>
        <circle cx="12" cy="12" r="1.5" fill="currentColor" opacity="0.6"/>
        <circle cx="10.5" cy="10.5" r="0.5" fill="currentColor" opacity="0.8"/>
    </svg>
);