// Lista completa dei paesi con codici ISO 3166-1 alpha-2
...
export const COUNTRIES: Country[] = [
    ...
    { code: 'SH', name: 'Sant\'Elena, Ascensione e Tristan da Cunha' },
    ...
    { code: 'TD', name: 'Ciad' },
    { code: 'TF', name: 'Terre Australi e Antartiche Francesi' },
    { code: 'TG', name: 'Togo' },
    ...
    { code: 'UG', name: 'Uganda' },
    { code: 'UM', name: 'Isole Minori Esterne degli Stati Uniti' },
...
// Funzione helper per ottenere il nome del paese dal codice
export const getCountryName = (code: string): string => {
    const country = COUNTRIES.find(c => c.code === code);
    return country ? country.name : code;
};

// Funzione helper per validare un codice paese
export const isValidCountryCode = (code: string): boolean => {
    return COUNTRIES.some(c => c.code === code);
};

// Paesi più comuni per l'Europa (per ordinamento prioritario)
export const COMMON_EUROPEAN_COUNTRIES = [
    'IT', 'FR', 'DE', 'ES', 'GB', 'NL', 'BE', 'AT', 'CH', 'PL'
];